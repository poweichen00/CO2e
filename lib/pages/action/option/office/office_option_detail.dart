...
class OfficeOptionDetail extends StatefulWidget {
  final int optionId;
  final OfficeOptionList officeOptionList;

  OfficeOptionDetail({
    required this.optionId,
    required this.officeOptionList,
  });
  @override
  _OfficeOptionDetailState createState() => _OfficeOptionDetailState();
}

class _OfficeOptionDetailState extends State<OfficeOptionDetail> {
  ...
  Widget build(BuildContext context) {
    final Option? option =
        widget.officeOptionList.getOptionById(widget.optionId);
