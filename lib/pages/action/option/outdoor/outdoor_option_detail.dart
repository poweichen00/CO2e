...
class OutdoorOptionDetail extends StatefulWidget {
  final int optionId;
  final OutdoorOptionList outdoorOptionList;

  OutdoorOptionDetail({
    required this.optionId,
    required this.outdoorOptionList,
  });
  @override
  _OutdoorOptionDetailState createState() => _OutdoorOptionDetailState();
}

class _OutdoorOptionDetailState extends State<OutdoorOptionDetail> {
  ...
  Widget build(BuildContext context) {
    final Option? option =
        widget.outdoorOptionList.getOptionById(widget.optionId);
          ...
          children: [
            Container(
              decoration: BoxDecoration(
                boxShadow: [
                  BoxShadow(
                    color: Color.fromARGB(255, 13, 96, 31)
